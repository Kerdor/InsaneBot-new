...
- Добавлена отдельная `ideas/PERMISSIONS.md`: тонкие allow/deny правила для cog/команд, приоритеты user/channel/role/server, global/server ACL, canrun/explain, YAML import/export, replace/update режимы, защита владельца от lockout и загрузка правил для ещё не загруженных модулей.
...
- В рамках дальнейшего обхода подробно просмотрены cleanup, moderation slowmode, kick/ban, modlog, moderation events/settings, core commands, permissions и trivia.
