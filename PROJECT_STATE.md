...
2. **python-discord/bot — следующий источник.**
...
Начать **только следующий источник: `python-discord/bot`** и повторить тот же принцип: идти по нему до конца, распределяя новые механики по тематическим файлам и не трогая следующие репозитории до его завершения.
