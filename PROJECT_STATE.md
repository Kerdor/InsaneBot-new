...
- Добавлен `ideas/RED_UNIQUE.md` с уникальными на текущем этапе находками из реального исходного кода Red-DiscordBot: алиасы, расширения custom commands, warning points/автодействия, user-name history, reports и communication tunnels, selfroles, глобальные announcements, serverlock и связанные UX-паттерны.
